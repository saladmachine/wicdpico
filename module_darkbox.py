...
class DarkBoxModule(WicdpicoModule):
    ...
    def _initialize_sensors(self):
        ...
        try:
            # --- FIX ---
            # Use the shared I2C bus from the foundation object.
            self.i2c = self.foundation.i2c
            
            # Check if the foundation failed to create the bus.
            if self.i2c is None:
                self.foundation.startup_print("✗ DarkBoxModule: I2C bus not available from foundation.")
                return
            
            self.foundation.startup_print("✓ DarkBoxModule is using the shared I2C bus.")
            # --- END FIX ---
